...
public class Event {
    ...
    /**
     * Returns the day of week (Calendar constants: 1=Sunday … 7=Saturday) for this event's date.
     * Returns -1 if date is null.
     */
    @Exclude
    ...
    /**
     * Returns the hour of day (0-23) for this event's date.
     * Returns -1 if date is null.
     */
    @Exclude
    ...
    /**
     * Returns true if the waiting list has space (unlimited or count < limit).
     */
    @Exclude
    public boolean hasWaitlistSpace() {
        if (waitingListLimit == -1) return true; // unlimited
        return waitingListCount < waitingListLimit;
    }

    /**
     * Returns true if the event is at full capacity (all confirmed spots taken).
     */
    @Exclude
    public boolean isFull() {
        if (capacity <= 0) return false; // no capacity set = not full
